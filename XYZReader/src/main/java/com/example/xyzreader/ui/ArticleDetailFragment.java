...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        AppBarLayout appbar = (AppBarLayout) mRootView.findViewById(R.id.ioexample_appbar);
        appbar.addOnOffsetChangedListener(this);
        mMaxScrollSize = appbar.getTotalScrollRange();
        float heightDp = getResources().getDisplayMetrics().heightPixels / 2 + 50;
    ...
    public void onOffsetChanged(AppBarLayout appBarLayout, int i) {
        ...
        if (percentage >= PERCENTAGE_TO_ANIMATE_AVATAR && mIsAvatarShown) {
            ...
            fab.animate().scaleY(0).scaleX(0).setDuration(200).start();
        }
